      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            disabled={disabled}
          ><ComboboxTrigger /></InputGroupButton>
        )}
...
function ComboboxChip({
  ...
  return (
    ...
    >
      {children}
      {showRemove && (
        <ComboboxPrimitive.ChipRemove className="-ml-1 opacity-50 hover:opacity-100" data-slot="combobox-chip-remove" render={<Button variant="ghost"size={"icon"}><XIcon className="pointer-events-none" /></Button>} />
      )}
    </ComboboxPrimitive.Chip>
  )
}
